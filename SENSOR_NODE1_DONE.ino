#define BLYNK_TEMPLATE_ID "TMPL66aFmFQze"
#define BLYNK_TEMPLATE_NAME "SENSOR NODE1"
#define BLYNK_AUTH_TOKEN "ypDesxss35Eqv4bEJ1qcvKsVCUzhclY4"
...
char ssid[] = "UTE WIFI";  // type your wifi name
char pass[] = "";  // typur wifi password
